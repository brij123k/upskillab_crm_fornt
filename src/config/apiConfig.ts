...
addNewLevel: `${url}/level`,  
  ...
  getHarericydetailStages:(employeeId:string)=>`${url}/leads/employee-team/${employeeId}`,
  getDetailofEmpStage:(employeeId:string)=>`${url}/leads/employee-stage-leads/${employeeId}`,
  stateWiseReport:`${url}/leads/report/state-wise`,
  stateWiseEmployeeReport:`${url}/leads/report/state-wise-employee`,
  stateWiseEmployeeReportTeam:`${url}/leads/report/state-wise-employee/team`,
  poolWiseStages:`${url}/leads/report/pool-wise-data`,
  poolWiseStagesleads:`${url}/leads/report/pool-wise-leads`,
  employeePoolRevenueReport:`${url}/order/report/employee-pool-revenue`,
  employeePoolRevenueReportteam:`${url}/order/report/employee-pool-revenue/team`,
  employeePoolUtilizationReport:`${url}/order/report/employee-pool-utilization`,
  employeePoolUtilizationReportTeam:`${url}/order/report/employee-pool-utilization/team`,
  employeeStageleads:`${url}/order/report/employee-stage-leads`,
  consultantPerforment:`${url}/order/report/consultant-performance`,
  consultantPerformentTeam:`${url}/order/report/consultant-performance/team`,
  consultantPerformentDetail:`${url}/order/report/consultant-performance/details`,
  employeePoolDailyUtilizationReport:`${url}/call-logs/report/employee-pool-daily-utilization`,
  employeePoolDailyUtilizationReportCalls:`${url}/call-logs/report/employee-pool-daily-utilization/calls`,
  employeePoolDailyUtilizationReportTeam:`${url}/call-logs/report/employee-pool-daily-utilization/team`,
